...
public class PropertyExample {
	...
	public static void main( String[] args) {
		...
		BiConsumer< String, Property< ?>> printProperty = ( name, p) -> 
			System.out.printf( "%s:\tState: %s%n\tValue: %s%n", name, p, p.getValue());
		...
		p1.addListener( (value, oldValue, newValue)->
			System.out.printf( "P1:\tChanging from \"%s\" to \"%s\"%n", oldValue, newValue));
		p2.addListener( (value, oldValue, newValue)->
			System.out.printf( "P2:\tChanging from \"%s\" to \"%s\"%n", oldValue, newValue));
