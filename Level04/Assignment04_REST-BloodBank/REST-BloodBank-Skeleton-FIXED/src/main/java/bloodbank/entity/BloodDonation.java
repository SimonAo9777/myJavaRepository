...
@NamedQuery(name = BloodDonation.FIND_ALL, query = "SELECT b FROM BloodDonation b left join fetch b.bank left join fetch b.record")//"SELECT b FROM BloodDonation b"
@NamedQuery( name = BloodDonation.FIND_BY_ID, query = "SELECT bb FROM BloodDonation bb where bb.id= :param1")//set param1
